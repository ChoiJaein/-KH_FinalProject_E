       ...
       <c:url var="noticeAddUrl" value="/notice/add"/>
          <form action="${noticeAddUrl}" method="post">
             ...
             <div class="mb-3 text-end">
                <c:url var="noticeUrl" value="/notcie/list"/>
                <button class="btn btn-primary" onclick="return addCancel();">취소</button>
                <button class="btn btn-primary" onclick="return addComplete(this.form);">완료</button>
             </div>
          </form>
       </div>
    </div>       
