...
<!--value에 data.noticeId // 어떤게시물에대한 수정인지 확인하기위한 hidden input-->          
           <input type="hidden" name ="id" value="">
             <div class="mb-3">
<!--value에 data.title -->            
                <input class="form-control" type="text" name="title" value="제 목" placeholder="제목을 입력하세요">
             </div>
             <hr>
             <div class="mb-3">
<!--value에 data.content -->                
                 <textarea class="form-control" name="content" rows="8"
                  placeholder="내용을 입력하세요">내 용</textarea>
             </div>
             <div class="mb-3 text-end">
                <button class="btn btn-primary" onclick="return addCancel();">취 소</button>
                <button class="btn btn-primary" onclick="modifyCheck(this.form);">수 정</button>
             </div>
          </form>
       </div> 
   </section>
